...
(define template `(*TOP* (*PI* xml "version=\"1.0\" encoding=\"UTF-8\"") "\n" 
			 ...
			 (html (|@| (xmlns "http://www.w3.org/1999/xhtml") (xml:lang "en") (lang "en"))
				...
				"\n"
				(div "\n" "    " (pre (|@| (class "buffer")) "\n" 
						      (span (|@| (class "linum") (id "L:1")) (a (|@| (href "#L:1")) " 1"))
						      (span (|@| (class "lfringe") (id "f:L;P:1;L:1")) " ")
						      (span (|@| (class "rfringe") (id "f:R;L:1")) " ")
						      (span (|@| (class "comment-delimiter") (id "F:1")) "/* ")
						      (span (|@| (class "comment") (id "F:4")) "Assembly code template for system call stubs.\n")
						      ) "\n")
				"\n"

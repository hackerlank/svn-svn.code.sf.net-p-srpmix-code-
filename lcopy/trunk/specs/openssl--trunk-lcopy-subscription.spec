%define lcopy_x_pkg   openssl
%define lcopy_x_phash o
%define lcopy_x_branch trunk
%define lcopy_x_vcs cvs
%define lcopy_x_vcs_pkg cvs
%define lcopy_x_repo :extssh:anonymous@cvs.openssl.org:/openssl-cvs

%define lcopy_branch_suffix %{?lcopy_x_branch:--%{lcopy_x_branch}}
%define lcopy_branch_doc    %{?lcopy_x_branch:(branch %{lcopy_x_branch}) }

%define lcopy_x_cmdline cvs -d:extssh:anonymous@cvs.openssl.org:/openssl-cvs checkout -P -d openssl openssl

%define lcopy_x_pkg   zsh
%define lcopy_x_phash z
%define lcopy_x_branch trunk
%define lcopy_x_vcs cvs
%define lcopy_x_vcs_pkg cvs
%define lcopy_x_repo :pserver:anonymous:@zsh.cvs.sourceforge.net:/cvsroot/zsh

%define lcopy_branch_suffix %{?lcopy_x_branch:--%{lcopy_x_branch}}
%define lcopy_branch_doc    %{?lcopy_x_branch:(branch %{lcopy_x_branch}) }

%define lcopy_x_cmdline cvs -d:pserver:anonymous:@zsh.cvs.sourceforge.net:/cvsroot/zsh checkout -P -d zsh zsh

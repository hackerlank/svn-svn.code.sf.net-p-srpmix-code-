Summary: A link from java-1.6.0-openjdk srpmix sources directory to java-1.6.0-openjdk--openjdk6 locpy directory
Name: java-1.6.0-openjdk--openjdk6-lcopy-link
Version: 0.0.13
Release: 0
License: GPL
...
java-1.6.0-openjdk--openjdk6 locpy directory.
...
%build
linkto=../../../../lcopy/sources/j/java-1.6.0-openjdk/openjdk6
builddistdir=%{_builddir}/%{name}/var/lib/srpmix/sources/j/java-1.6.0-openjdk
mkdir -p ${builddistdir}
ln -sf $linkto ${builddistdir}/\%openjdk6

%define lcopy_x_pkg   emacs-w3m
%define lcopy_x_phash e
%define lcopy_x_branch trunk
%define lcopy_x_vcs cvs
%define lcopy_x_vcs_pkg cvs
%define lcopy_x_repo :pserver:anonymous:@cvs.namazu.org:/storage/cvsroot

%define lcopy_branch_suffix %{?lcopy_x_branch:--%{lcopy_x_branch}}
%define lcopy_branch_doc    %{?lcopy_x_branch:(branch %{lcopy_x_branch}) }

%define lcopy_x_cmdline cvs -d:pserver:anonymous:@cvs.namazu.org:/storage/cvsroot checkout -P -d emacs-w3m emacs-w3m

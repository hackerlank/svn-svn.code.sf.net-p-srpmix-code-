%define lcopy_x_pkg   silentbob
%define lcopy_x_phash s
%define lcopy_x_branch trunk
%define lcopy_x_vcs svn
%define lcopy_x_vcs_pkg subversion
%define lcopy_x_repo https://silentbob.svn.sourceforge.net/svnroot/silentbob/branches/silentbob2

%define lcopy_branch_suffix %{?lcopy_x_branch:--%{lcopy_x_branch}}
%define lcopy_branch_doc    %{?lcopy_x_branch:(branch %{lcopy_x_branch}) }

%define lcopy_x_cmdline svn checkout https://silentbob.svn.sourceforge.net/svnroot/silentbob/branches/silentbob2 silentbob
...
%changelog
* Thu May 14 2009 lcopy genspec <yamato@redhat.com> - lcopy-subscription
- Built automatically.

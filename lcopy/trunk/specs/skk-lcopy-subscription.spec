%define lcopy_x_pkg skk
%define lcopy_x_branch 
%define lcopy_x_vcs cvs
%define lcopy_x_vcs_pkg cvs
%define lcopy_x_repo :pserver:guest:guest@openlab.jp:/circus/cvsroot

%define lcopy_branch_suffix %{?lcopy_x_branch:--%{lcopy_x_branch}}
%define lcopy_branch_doc    %{?lcopy_x_branch:(branch %{lcopy_x_branch}) }

%define lcopy_x_cmdline cvs -d:pserver:guest:guest@openlab.jp:/circus/cvsroot checkout -P -d skk skk/main

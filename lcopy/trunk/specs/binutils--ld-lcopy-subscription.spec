%define lcopy_x_pkg   binutils
%define lcopy_x_phash b
%define lcopy_x_branch ld
%define lcopy_x_vcs cvs
%define lcopy_x_vcs_pkg cvs
%define lcopy_x_repo :pserver:anoncvs:anoncvs@sourceware.org:/cvs/src

%define lcopy_branch_suffix %{?lcopy_x_branch:--%{lcopy_x_branch}}
%define lcopy_branch_doc    %{?lcopy_x_branch:(branch %{lcopy_x_branch}) }

%define lcopy_x_cmdline cvs -d:pserver:anoncvs:anoncvs@sourceware.org:/cvs/src checkout -P -d binutils ld
...
%post
cd %{lcopy_srcdir}
test -d %{lcopy_x_phash}/%{lcopy_x_pkg}/%{lcopy_x_branch} || lcopy --branch=ld --no-spec %{lcopy_x_cmdline}
...
%changelog
* Wed Jan 28 2009 lcopy genspec <yamato@redhat.com> - lcopy-subscription
- Built automatically.

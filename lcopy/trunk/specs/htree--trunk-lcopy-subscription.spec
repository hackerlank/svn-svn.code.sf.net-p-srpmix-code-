%define lcopy_x_pkg   htree
%define lcopy_x_phash h
%define lcopy_x_branch trunk
%define lcopy_x_vcs cvs
%define lcopy_x_vcs_pkg cvs
%define lcopy_x_repo :pserver:anonymous:@cvs.m17n.org:/cvs/ruby

%define lcopy_branch_suffix %{?lcopy_x_branch:--%{lcopy_x_branch}}
%define lcopy_branch_doc    %{?lcopy_x_branch:(branch %{lcopy_x_branch}) }

%define lcopy_x_cmdline cvs -d:pserver:anonymous:@cvs.m17n.org:/cvs/ruby checkout -P -d htree htree
...
%changelog
* Thu Mar 12 2009 lcopy genspec <yamato@redhat.com> - lcopy-subscription
- Built automatically.

...
%define lcopy_x_branch openjdk6
%define lcopy_x_vcs hg
%define lcopy_x_vcs_pkg mercurial
%define lcopy_x_repo http://icedtea.classpath.org/hg/openjdk6

%define lcopy_branch_suffix %{?lcopy_x_branch:--%{lcopy_x_branch}}
%define lcopy_branch_doc    %{?lcopy_x_branch:(branch %{lcopy_x_branch}) }

%define lcopy_x_cmdline hg clone http://icedtea.classpath.org/hg/openjdk6 java-1.6.0-openjdk
...
%post
cd %{lcopy_srcdir}
test -d %{lcopy_x_phash}/%{lcopy_x_pkg}/%{lcopy_x_branch} || lcopy --branch=openjdk6 --no-spec %{lcopy_x_cmdline}

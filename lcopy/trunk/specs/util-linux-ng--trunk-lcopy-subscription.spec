%define lcopy_x_pkg   util-linux-ng
%define lcopy_x_phash u
%define lcopy_x_branch trunk
%define lcopy_x_vcs git
%define lcopy_x_vcs_pkg git
%define lcopy_x_repo git://git.kernel.org/pub/scm/utils/util-linux-ng/util-linux-ng.git

%define lcopy_branch_suffix %{?lcopy_x_branch:--%{lcopy_x_branch}}
%define lcopy_branch_doc    %{?lcopy_x_branch:(branch %{lcopy_x_branch}) }

%define lcopy_x_cmdline git clone git://git.kernel.org/pub/scm/utils/util-linux-ng/util-linux-ng.git util-linux-ng
...
%changelog
* Thu Feb 26 2009 lcopy genspec <yamato@redhat.com> - lcopy-subscription
- Built automatically.

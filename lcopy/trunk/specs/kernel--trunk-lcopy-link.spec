Summary: A link from kernel srpmix sources directory to kernel--trunk locpy directory
Name: kernel--trunk-lcopy-link
Version: 0.0.12
Release: 0
License: GPL
...
%build
linkto=../../../../lcopy/sources/k/kernel/trunk

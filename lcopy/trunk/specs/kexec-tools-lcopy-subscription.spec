%define lcopy_x_pkg kexec-tools
%define lcopy_x_branch 
%define lcopy_x_vcs git
%define lcopy_x_vcs_pkg git
%define lcopy_x_repo git://git.kernel.org/pub/scm/linux/kernel/git/horms/kexec-tools.git

%define lcopy_branch_suffix %{?lcopy_x_branch:--%{lcopy_x_branch}}
%define lcopy_branch_doc    %{?lcopy_x_branch:(branch %{lcopy_x_branch}) }

%define lcopy_x_cmdline git clone git://git.kernel.org/pub/scm/linux/kernel/git/horms/kexec-tools.git kexec-tools
...
%changelog
* Mon Jan 19 2009 lcopy genspec <yamato@redhat.com> - lcopy-subscription
- Built automatically.

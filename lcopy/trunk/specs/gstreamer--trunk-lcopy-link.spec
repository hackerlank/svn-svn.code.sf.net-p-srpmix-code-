Summary: A link from gstreamer srpmix sources directory to gstreamer--trunk locpy directory
Name: gstreamer--trunk-lcopy-link
Version: 0.0.12
Release: 0
License: GPL
...
gstreamer--trunk locpy directory.
...
%build
linkto=../../../../lcopy/sources/g/gstreamer/trunk

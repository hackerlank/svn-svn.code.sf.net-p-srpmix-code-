%define lcopy_x_pkg   cvs
%define lcopy_x_phash c
%define lcopy_x_branch trunk
%define lcopy_x_vcs cvs
%define lcopy_x_vcs_pkg cvs
%define lcopy_x_repo :pserver:anonymous:@cvs.savannah.nongnu.org:/sources/cvs

%define lcopy_branch_suffix %{?lcopy_x_branch:--%{lcopy_x_branch}}
%define lcopy_branch_doc    %{?lcopy_x_branch:(branch %{lcopy_x_branch}) }

%define lcopy_x_cmdline cvs -d:pserver:anonymous:@cvs.savannah.nongnu.org:/sources/cvs checkout -P -d cvs ccvs

%define lcopy_version 0.0.16
...
%changelog
* Mon Mar 30 2009 lcopy genspec <yamato@redhat.com> - lcopy-subscription
- Built automatically.

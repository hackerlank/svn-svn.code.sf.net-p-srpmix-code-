Summary: A link from ConsoleKit srpmix sources directory to ConsoleKit--trunk locpy directory
Name: ConsoleKit--trunk-lcopy-link
Version: 0.0.12
Release: 0
License: GPL
...
ConsoleKit--trunk locpy directory.
...
%build
linkto=../../../../lcopy/sources/C/ConsoleKit/trunk

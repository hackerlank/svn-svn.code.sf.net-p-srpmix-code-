Summary: A link from tomoe srpmix sources directory to tomoe--trunk locpy directory
Name: tomoe--trunk-lcopy-link
Version: 0.0.12
Release: 0
License: GPL
...
%build
linkto=../../../../lcopy/sources/t/tomoe/trunk

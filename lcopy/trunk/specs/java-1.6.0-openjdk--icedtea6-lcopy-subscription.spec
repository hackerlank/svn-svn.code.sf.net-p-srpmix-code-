%define lcopy_x_pkg   java-1.6.0-openjdk
%define lcopy_x_phash j
%define lcopy_x_branch icedtea6
%define lcopy_x_vcs hg
%define lcopy_x_vcs_pkg mercurial
%define lcopy_x_repo http://icedtea.classpath.org/hg/icedtea6

%define lcopy_branch_suffix %{?lcopy_x_branch:--%{lcopy_x_branch}}
%define lcopy_branch_doc    %{?lcopy_x_branch:(branch %{lcopy_x_branch}) }

%define lcopy_x_cmdline hg clone http://icedtea.classpath.org/hg/icedtea6 java-1.6.0-openjdk

%define lcopy_version 0.0.13
...
%post
cd %{lcopy_srcdir}
test -d %{lcopy_x_phash}/%{lcopy_x_pkg}/%{lcopy_x_branch} || lcopy --branch=icedtea6 --no-spec %{lcopy_x_cmdline}
...
%changelog
* Thu Jan 29 2009 lcopy genspec <yamato@redhat.com> - lcopy-subscription
- Built automatically.

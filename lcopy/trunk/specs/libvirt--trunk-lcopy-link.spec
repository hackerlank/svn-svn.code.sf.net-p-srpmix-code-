Summary: A link from libvirt srpmix sources directory to libvirt--trunk locpy directory
Name: libvirt--trunk-lcopy-link
Version: 0.0.12
Release: 0
License: GPL
...
%build
linkto=../../../../lcopy/sources/l/libvirt/trunk

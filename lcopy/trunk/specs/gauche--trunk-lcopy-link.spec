Summary: A link from gauche srpmix sources directory to gauche--trunk locpy directory
Name: gauche--trunk-lcopy-link
Version: 0.0.12
Release: 0
License: GPL
...
%build
linkto=../../../../lcopy/sources/g/gauche/trunk

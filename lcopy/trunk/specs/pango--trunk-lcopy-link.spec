Summary: A link from pango srpmix sources directory to pango--trunk locpy directory
Name: pango--trunk-lcopy-link
Version: 0.0.12
Release: 0
License: GPL
...
%build
linkto=../../../../lcopy/sources/p/pango/trunk

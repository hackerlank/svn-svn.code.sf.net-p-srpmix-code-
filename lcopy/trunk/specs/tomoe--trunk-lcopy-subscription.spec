%define lcopy_x_pkg   tomoe
%define lcopy_x_phash t
%define lcopy_x_branch trunk
%define lcopy_x_vcs svn
%define lcopy_x_vcs_pkg subversion
%define lcopy_x_repo https://tomoe.svn.sourceforge.net/svnroot/tomoe/tomoe/trunk

%define lcopy_branch_suffix %{?lcopy_x_branch:--%{lcopy_x_branch}}
%define lcopy_branch_doc    %{?lcopy_x_branch:(branch %{lcopy_x_branch}) }

%define lcopy_x_cmdline svn checkout https://tomoe.svn.sourceforge.net/svnroot/tomoe/tomoe/trunk tomoe

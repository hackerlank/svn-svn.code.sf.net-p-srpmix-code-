...
%define lcopy_x_branch rt
%define lcopy_x_vcs git
%define lcopy_x_vcs_pkg git
%define lcopy_x_repo git://git.kernel.org/pub/scm/linux/kernel/git/rostedt/linux-2.6-rt.git

%define lcopy_branch_suffix %{?lcopy_x_branch:--%{lcopy_x_branch}}
%define lcopy_branch_doc    %{?lcopy_x_branch:(branch %{lcopy_x_branch}) }

%define lcopy_x_cmdline git clone git://git.kernel.org/pub/scm/linux/kernel/git/rostedt/linux-2.6-rt.git kernel
...
%post
cd %{lcopy_srcdir}
test -d %{lcopy_x_phash}/%{lcopy_x_pkg}/%{lcopy_x_branch} || lcopy --branch=rt --no-spec %{lcopy_x_cmdline}

Summary: A link from goocanvas srpmix sources directory to goocanvas locpy directory
Name: goocanvas-lcopy-link
Version: 0.0.9
Release: 0
License: GPL
...
%build
linkto=../../../../lcopy/sources/goocanvas

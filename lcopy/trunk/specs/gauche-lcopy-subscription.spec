%define lcopy_x_pkg gauche
%define lcopy_x_branch 
%define lcopy_x_vcs svn
%define lcopy_x_vcs_pkg subversion
%define lcopy_x_repo https://gauche.svn.sourceforge.net/svnroot/gauche/Gauche/trunk

%define lcopy_branch_suffix %{?lcopy_x_branch:--%{lcopy_x_branch}}
%define lcopy_branch_doc    %{?lcopy_x_branch:(branch %{lcopy_x_branch}) }

%define lcopy_x_cmdline svn checkout https://gauche.svn.sourceforge.net/svnroot/gauche/Gauche/trunk gauche
